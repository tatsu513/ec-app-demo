...
exports.stripeCustomer = functions.https.onRequest((req, res) => {
  ...
  corsHandler(req, res, () => {
    if (req.method !== "POST") {
      sendResponse(res, 405, {error: "Invalid requested method"});
    }
...
exports.retrievePaymentMethod = functions.https.onRequest((req, res) => {
  ...
  corsHandler(req, res, () => {
    ...
    return stripe.paymentMethods.retrieve(req.body.paymentMethodId)
        .then((paymentMethod) => {
...
exports.updatePaymentMethod = functions.https.onRequest((req, res) => {
  ...
  corsHandler(req, res, () => {
    ...
    return stripe.paymentMethods.detach(req.body.prevPaymentMethodId)
        .then(() => {
